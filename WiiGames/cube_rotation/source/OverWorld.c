...
const u32 colPla[10] = { 0xFFFFFFFF,0x00000080,0x008000FF,0xFF0000FF,0x0000FFFF };
// white, black, green, red, blue, yellow, purple, pink,lime

void drawPlayerWorld(int x, int y) {
    GRRLIB_ObjectViewBegin();
    GRRLIB_ObjectViewRotate(x, y, 0);
    GRRLIB_ObjectViewTrans(0, 0, 0);
    GRRLIB_ObjectViewEnd();
    GRRLIB_DrawCube(1, 1, colPla[4]);
}
